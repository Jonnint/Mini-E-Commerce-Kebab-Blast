...
@section('title', 'Daftar - Kebab Blast')
    ...
    <div class="max-w-md mx-auto">
        <div class="glass rounded-3xl shadow-2xl p-8 md:p-10 animate-fade-in-up">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-400">Bergabung dengan Kebab Blast</p>
            </div>
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="text" name="name" value="{{ old('name') }}" 
                            class="w-full pl-12 pr-4 py-3 bg-gray-800/50 border-2 border-gray-700 rounded-xl focus:outline-none focus:border-orange-500 transition-all duration-300 @error('name') border-red-500 @enderror"
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="password" name="password_confirmation" 
                            class="w-full pl-12 pr-4 py-3 bg-gray-800/50 border-2 border-gray-700 rounded-xl focus:outline-none focus:border-orange-500 transition-all duration-300"
                            placeholder="••••••••"
                            required>
                    </div>
                </div>
            ...
            <div class="mt-8 text-center">
                <p class="text-gray-400">
                    Sudah punya akun? 
                    <a href="{{ route('login') }}" class="text-orange-400 hover:text-orange-300 font-semibold transition-colors duration-300">
                        Masuk
                    </a>
                </p>
            </div>
